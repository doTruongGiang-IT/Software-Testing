...
public class TestCase01 {
	...
	public void signInWithFaceBook() throws InterruptedException {
		...
		password.clear();
		password.sendKeys("uocgitrungso");
...
//		WebElement username = driver.findElement(By.xpath("//*[@id=\"main\"]/div/div[2]/div/div/form/div/div[2]/div[3]/div[1]/input"));
//		username.clear();
//		username.sendKeys("dotruonggiang_"+num);
//		// Click SignIn button
//		driver.findElement(By.xpath("//*[@id=\"main\"]/div/div[2]/div/div/form/div/div[2]/div[6]/button[2]")).click();
		driver.findElement(By.xpath("//*[@id=\"modal\"]/div/div/div[2]/div")).click();
		driver.quit();
	};
}
